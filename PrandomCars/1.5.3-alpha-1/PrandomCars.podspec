...
Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://raw.githubusercontent.com/tareq3/RandomCarsLibs/main/alpha-1.5.3/WeavrComponents.xcframework.zip" }
  ...
  s.subspec 'Combined' do |sp|
    ...
    sp.dependency 'IdensicMobileSDK', '1.28.0'
    s.dependency 'PSASDK', '1.2.12'
    s.dependency 'FlutterCommunicationChannel', '1.3.0'
  end
